...
def parseInput():
    parser = argparse.ArgumentParser(description='Helper script, that reads excel data, processes them in pandas and writes them back into excel.')
    parser.add_argument('-p', '--paramsFile',  type=str, help='Optional path for parameters file. Defaulted to ./parameters.yaml', default='parameters.yaml', required=False)
